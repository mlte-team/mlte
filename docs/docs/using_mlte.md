...
- ``set_credentials("user")``: this command sets the provided user name as the current user. It is used to give attribution when creating/editing artifacts.
