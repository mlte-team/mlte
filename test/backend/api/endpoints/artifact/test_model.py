...
def test_health(
    test_api_fixture, api_user: UserWithPassword = test_users.build_test_user()
) -> None:
...
@pytest.mark.parametrize(
    "api_user",
    test_users.get_test_users_with_write_permissions(ResourceType.MODEL),
)
...
@pytest.mark.parametrize(
    "api_user",
    test_users.get_test_users_with_no_write_permissions(ResourceType.MODEL),
)
...
@pytest.mark.parametrize(
    "api_user",
    test_users.get_test_users_with_read_permissions(ResourceType.MODEL),
)
...
@pytest.mark.parametrize(
    "api_user",
    test_users.get_test_users_with_no_read_permissions(ResourceType.MODEL),
)
