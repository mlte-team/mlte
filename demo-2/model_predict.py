...
parser.add_argument("--model", help="The json formatted model file.", required=True)
...
print("\n--- STATISTICS ---")
print("Average elapsed time per inference: {0:.5f} seconds".format(avg_elapsed_time))
print(
