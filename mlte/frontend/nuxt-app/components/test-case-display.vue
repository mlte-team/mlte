<template>
  <div>
    ...
    <ul>
      <li v-for="(testCase, caseIndex) in props.testCases" :key="caseIndex">
        {{ testCase.identifier }}
        <ul>
          ...
          <li>
            ...
            <ul>
              <li v-for="(qas, qasIndex) in testCase.qas_list" :key="qasIndex">
                {{ qas }}
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li>
                <b>Boolean Expression: </b>{{ testCase.validator.bool_exp_str }}
              </li>
              <li>
                <b>Thresholds</b>
                <ul>
              ...
              <li>
                ...
                <ul>
                  <li
                    v-for="(type, typeIndex) in testCase.validator.input_types"
                    :key="typeIndex"
                  >
                    {{ type }}
                  </li>
...
import MeasurementDisplay from "./measurement-display.vue";
